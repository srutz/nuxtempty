<template>
    <div class="h-1 grow flex flex-col gap-2 pt-4 items-center">
        ...
        <div v-if="pending && delayedPending" class="h-1 grow flex flex-col gap-4 p-4 items-center justify-center"
            v-auto-animate>
        ...
        <div v-else class="flex flex-wrap overflow-y-auto pt-4 pl-4 gap-1" v-auto-animate="{ duration: 100 }">
            <NuxtLink v-for="product in products" :key="product.id" :to="'/products/product/' + product.id">
